...
| `corpus/` | 72 golden chains (`golden/*.ilang`) with their expected IML on the 0.3 surface (`golden-0.3/`) and on the 0.2 surface (`golden/*.iml`, the record); 134 malformed inputs with their expected error codes, each naming its surface. |
